...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--pad_mode", type=str, default="circular", choices=["constant", "reflect", "replicate", "circular"], help="Padding mode for constant-length wavelet decomposition")
